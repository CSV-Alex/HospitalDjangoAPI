...
class HospitalizacionRequestSerializer(serializers.Serializer):
    numeroOrden = serializers.CharField(max_length=50, help_text="Número de orden de Bonita BPM")
    dniPaciente = serializers.CharField(max_length=8, help_text="DNI del paciente")
    especialidad = serializers.CharField(max_length=100, help_text="Especialidad solicitada")
    codigoCama = serializers.CharField(max_length=50, help_text="Código de cama")
