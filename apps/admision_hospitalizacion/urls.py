...
urlpatterns = [
    ...
    # Nuevo endpoint para hospitalización directa vía REST
    path('api/hospitalizacion/', views.procesar_solicitud_hospitalizacion_api, name='procesar_hospitalizacion'),
]
